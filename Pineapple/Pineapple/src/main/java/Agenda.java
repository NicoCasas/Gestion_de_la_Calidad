...
public class Agenda implements Interfaz_Agenda, Subject {
    ...
    /*
     * consultar turno disponibles: { valido: JSON_array medicos:[ nombre_medico1:
     * arrayList_horarios[] nombre_medico2: arrayList_horarios[] ] } /*
     */
    @Override
    ...
    /*
     * turnos resevados medico { valido: turnos:JSONArray[ { nombre_paciente:
     * horario: } ] }
     */

...
public class AgendaGUI extends JFrame {
	...
	public JSONObject getNomConID(JSONObject json_object) {
		if (!validadorMedicx.validarID(json_object)) {
			return ErrNomID();
		}
		return gestor_medicx.getNomConID(json_object);
	}

	private JSONObject iniciarSesion(JSONObject jo) {
		if (!validadorMedicx.validarMatricula(jo)) {
			return ErrValMat();
		}
		return gestor_medicx.iniciarSesion(jo);
	}
    ...
    public JSONObject getIDConNom(JSONObject json_object) {
        if (!validadorMedicx.validarNombre(json_object)) {
            return ErrIDNom();
        }
	...
	public AgendaGUI(String title, Interfaz_Validacion_Turno validadorTurnos,
			Interfaz_Validacion_Medicx validadorMedicx, Gestor_Medicx gestor) {
		super(title);
		...
		/**
		 * Método acción al presionar el botón "Reservar Turno" Cambia a VISTA PRINCIPAL
		 * por VISTA CREAR TURNO
		 */
		...
		/**
		 * Método acción al presionar el botón "Consultar Turno" Cambia a VISTA
		 * PRINCIPAL por VISTA CONSULTAR TURNO
		 */
		...
		/**
		 * Método acción al presionar el botón "Ver Turnos Disponibles" Despliega nueva
		 * ventana con VISTA TURNOS DISPONIBLES
		 */
		verTurnosButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				VistaTurnosDisp vistaTurnosDisp = new VistaTurnosDisp("My Agenda", AgendaGUI.this.validadorTurnos,
						AgendaGUI.this.validadorMedicx, AgendaGUI.this.gestor_medicx);
				vistaTurnosDisp.cargarVistaContent();
				vistaTurnosDisp.setVisible(true);
			}
		});
		/**
		 * Método acción al presionar el botón "Iniciar Sesión" Cambia a VISTA PRINCIPAL
		 * por VISTA INICIO DE SESIÓN
		 */
		...
		/**
		 * Método acción al presionar el botón "Iniciar Sesión" Envia credenciales de
		 * logueo a Interfaz_Validacion_Medico para su validacion Si son validas: cambia
		 * VISTA INICIO DE SESIÓN por VISTA TURNOS RESERVADOS POR MÉDICO Si son
		 * invalidas: imprime mensaje de error
		 */
		loginButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (jo.getString(VALIDO_KEY).equals("si")) {
					...
					nombreDoctor.setText(getNomConID(jo).getString(NOMBRE_MEDICX_KEY));
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA INICIO DE SESIÓN
		 * por VISTA PRINCIPAL
		 */
		...
		/**
		 * Método acción al presionar el botón "Consultar" Envia dni a consultar a
		 * Interfaz_Validacion_Turno para su validación Si es valido: cambia VISTA
		 * CONSULTAR TURNO por VISTA TURNO CONSULTADO Si es invalido: imprime mensaje de
		 * error
		 */
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (jo_consultado.getString(VALIDO_KEY).equals("si")) {
					...
					textoMostrarTurnoPanel.setText("Paciente: " + jo_consultado.getString(NOMBRE_KEY) + "\n"
							+ "Medicx: " + (getNomConID(jo_consultado).getString(NOMBRE_MEDICX_KEY)) + "\n" + "Hora: "
							+ jo_consultado.getString(HORA_KEY) + "\n" + "Método de Pago: "
							+ jo_consultado.getString(METODO_DE_PAGO_KEY) + "\n");
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA CONSULTAR TURNO
		 * por VISTA PRINCIPAL
		 */
		...
		/**
		 * Método acción al presionar el botón "Consultar" Envia datos para crear un
		 * nuevo turno a Interfaz_Validacion_Turno para su validación Si son validos:
		 * imprime ticket del nuevo turno creado Si son invalidos: imprime mensaje de
		 * error
		 */
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (pagoBox1.getSelectedItem().toString().equals("Efectivo")) {
					...
					if (pagoBox1.getSelectedItem().toString().equals("Tarjeta De Debito")) {
						...
						jo.put(VENCIMIENTO_TARJETA_KEY, mesDebitoBox.getSelectedItem().toString() + "/"
								+ anioDebitoBox.getSelectedItem().toString());
					} else {
						jo.put(NUMERO_TARJETA_KEY, numeroTarjetaCredito.getText());
						jo.put(CODSEG_TARJETA_KEY, codSegTarjetaCredito.getText());
						jo.put(VENCIMIENTO_TARJETA_KEY, mesCreditoBox.getSelectedItem().toString() + "/"
								+ anioCreditoBox.getSelectedItem().toString());
				...
				if (jo.getString(VALIDO_KEY).equals("si")) {
					...
					jo.put(NOMBRE_MEDICX_KEY, medicxsBox.getSelectedItem().toString());
					setHorarioModel(getIDConNom(jo).getString(NOMBRE_MEDICX_KEY));
				} else {
					JOptionPane.showMessageDialog(null, jo.getString(ERROR_KEY));
				}
			}
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA CREAR TURNO por
		 * VISTA PRINCIPAL
		 */
		...
		/**
		 * Método acción al seleccionar una opccion de desplegable de "Medicxs" Llama a
		 * la funcion setHorarioModel para setear las opciones disponibles en el
		 * desplegable "Horario:" para el medico seleccionado
		 */
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA TURNOS RESERVADOS
		 * POR MÉDICO por VISTA INICIO DE SESIÓN
		 */
		...
		/**
		 * Método acción al presionar el botón "Cambiar Metodo De Pago" Cambia VISTA
		 * TURNO CONSULTADO por VISTA CAMBIAR METODO DE PAGO
		 */
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA TURNO CONSULTADO
		 * por VISTA PRINCIPAL
		 */
		...
		/**
		 * Método acción al presionar el botón "Realizar Cambio" Envia datos para
		 * cambiar metodo de pago del turno consultado a Interfaz_Validacion_Turno para
		 * su validación Si son validos: imprime ticket del turno con los nuevos datos
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (pagoBox2.getSelectedItem().toString().equals("Efectivo")) {
					...
					if (pagoBox1.getSelectedItem().toString().equals("Tarjeta De Debito")) {
						...
						jo_consultado.put(VENCIMIENTO_TARJETA_KEY, mesDebitoCambiarBox.getSelectedItem().toString()
								+ "/" + anioDebitoCambiarBox.getSelectedItem().toString());
					} else {
						...
						jo_consultado.put(VENCIMIENTO_TARJETA_KEY, mesCreditoCambiarBox.getSelectedItem().toString()
								+ "/" + anioCreditoCambiarBox.getSelectedItem().toString());
		...
		/**
		 * Método acción al presionar el botón "Volver" Cambia a VISTA AMBIAR METODO DE
		 * PAGO por VISTA TURNO CONSULTADO
		 */
		...
		pagoBox2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				case "Efectivo":
					cambiarEfectivoPanel.setVisible(true);
					break;
				case "Tarjeta De Debito":
					cambiarDebitoPanel.setVisible(true);
					break;
				case "Tarjeta De Credito":
					cambiarCreditoPanel.setVisible(true);
					break;
				}
			}
		});
	 ...
	 *
	 * @param: String nombre_medico - Nombre del medico seleccionado en JComboBox
	 *                "Medicxs"
	 */
	...
	/**
	 * Metodo de limpieza de la VISTA CREAR TURNO Regresa todos los campos al valor
	 * original
	 */
	...
	/**
	 * Metodo de limpieza de la VISTA CAMBIAR METODO DE PAGO Regresa todos los
	 * campos al valor original
	 */
	...
	private void goTo(String vista) {
		...
		switch (vista) {
		case VISTA_INICIO_DE_SESION:
			sesionPanel.setVisible(true);
			break;
		case VISTA_CONSULTAR_TURNO:
			consultaPanel.setVisible(true);
			break;
		case VISTA_CREAR_TURNO:
			crearPanel.setVisible(true);
			break;
		case VISTA_TURNOS_RESERVADOS_POR_MEDICO:
			turnosReservMedicxPanel.setVisible(true);
			break;
		case VISTA_TURNO_CONSULTADO:
			mostrarTurnoConsultadoPanel.setVisible(true);
			break;
		case VISTA_CAMBIAR_METODO_DE_PAGO:
			cambiarMetodoPagoPanel.setVisible(true);
			break;
		default:
	...
	/**
	 * Método de inicializacion de la GUI carga las vistas
	 */
	private void initGUI() {
		...
		for (int i = 0; i < id_medicos.size(); i++) {
			...
			arr[i] = getNomConID(jo).getString(NOMBRE_MEDICX_KEY);
		}
		...
		if (id_medicos.size() > 0) {
			...
			setHorarioModel(getNomConID(jo).getString(NOMBRE_MEDICX_KEY));
		}
	...
	private void $$$setupUI$$$() {
		...
		mainButtonsPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(4, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		...
		mainButtonsPanel.add(iniciarSesion,
				new com.intellij.uiDesigner.core.GridConstraints(3, 0, 1, 1,
						...
						new java.awt.Dimension(50, 50), null, 0, false));
		...
		mainButtonsPanel.add(crearTurnoButton,
		...
		mainButtonsPanel.add(verTurnosButton,
		...
		mainPanel.add(spacer1, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer2 = new com.intellij.uiDesigner.core.Spacer();
		mainPanel.add(spacer2, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		sesionPanel = new JPanel();
		sesionPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(3, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		ViewPanel.add(sesionPanel, "Card2");
		matriculaSesionPanel = new JPanel();
		matriculaSesionPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		sesionPanel.add(matriculaSesionPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		matriculaSesionPanel.add(matriculaLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
		...
		matriculaSesionPanel.add(matriculaIncorrectaLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(10, -1), null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer3 = new com.intellij.uiDesigner.core.Spacer();
		matriculaSesionPanel.add(spacer3, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer4 = new com.intellij.uiDesigner.core.Spacer();
		matriculaSesionPanel.add(spacer4, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		matricula = new JTextField();
		matriculaSesionPanel.add(matricula,
				new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(150, -1), null, 0, false));
		buttonsSesionPanel = new JPanel();
		buttonsSesionPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		sesionPanel.add(buttonsSesionPanel,
				new com.intellij.uiDesigner.core.GridConstraints(2, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel1.add(backSesionButton,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						...
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
								| com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(150, 30), null, 0, false));
		...
		buttonsSesionPanel.add(spacer5, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer6 = new com.intellij.uiDesigner.core.Spacer();
		buttonsSesionPanel.add(spacer6, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer7 = new com.intellij.uiDesigner.core.Spacer();
		buttonsSesionPanel.add(spacer7, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		passwordSesionPanel = new JPanel();
		passwordSesionPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		...
		passwordSesionPanel.add(passwordLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		passwordSesionPanel.add(password,
				new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		passwordSesionPanel.add(spacer8, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer9 = new com.intellij.uiDesigner.core.Spacer();
		passwordSesionPanel.add(spacer9, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		consultaPanel = new JPanel();
		consultaPanel.setLayout(
		...
		dniConsultaPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 4, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		consultaPanel.add(dniConsultaPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		dniConsultaPanel.add(dniLabel1,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		dniConsultaPanel.add(dniConsulta,
				new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		dniConsultaPanel.add(spacer10, new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer11 = new com.intellij.uiDesigner.core.Spacer();
		dniConsultaPanel.add(spacer11, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		buttonsConsultaPanel = new JPanel();
		buttonsConsultaPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		consultaPanel.add(buttonsConsultaPanel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel3.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		buttonsConsultaPanel.add(panel3,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel4.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		buttonsConsultaPanel.add(panel4,
				new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		buttonsConsultaPanel.add(spacer12, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer13 = new com.intellij.uiDesigner.core.Spacer();
		buttonsConsultaPanel.add(spacer13, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer14 = new com.intellij.uiDesigner.core.Spacer();
		buttonsConsultaPanel.add(spacer14, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		crearPanel = new JPanel();
		crearPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(2, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		ViewPanel.add(crearPanel, "Card4");
		buttonsPagoPanel = new JPanel();
		buttonsPagoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		crearPanel.add(buttonsPagoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		buttonsPagoPanel.add(spacer15, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer16 = new com.intellij.uiDesigner.core.Spacer();
		buttonsPagoPanel.add(spacer16, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer17 = new com.intellij.uiDesigner.core.Spacer();
		buttonsPagoPanel.add(spacer17, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		ingresoDatosCrearPanel = new JPanel();
		ingresoDatosCrearPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(2, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		crearPanel.add(ingresoDatosCrearPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		datosPacientePagoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(5, 4, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		ingresoDatosCrearPanel.add(datosPacientePagoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		datosPacientePagoPanel.add(pagoBox1,
		...
		datosPacientePagoPanel.add(nombrePaciente,
		...
		datosPacientePagoPanel.add(dniCrear,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 3,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
		...
		datosPacientePagoPanel.add(medicxsBox,
				new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 3,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
		...
		datosPacientePagoPanel.add(horarioBox,
				new com.intellij.uiDesigner.core.GridConstraints(3, 1, 1, 3,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
		...
		datosPacientePagoPanel.add(dniLabel2,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		datosPacientePagoPanel.add(pagoLabel1,
				new com.intellij.uiDesigner.core.GridConstraints(4, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(120, -1), null, 0, false));
		costoConsultaLabel1 = new JLabel();
		datosPacientePagoPanel.add(costoConsultaLabel1,
				new com.intellij.uiDesigner.core.GridConstraints(4, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer18 = new com.intellij.uiDesigner.core.Spacer();
		datosPacientePagoPanel.add(spacer18, new com.intellij.uiDesigner.core.GridConstraints(4, 3, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		metodoPagoPanel = new JPanel();
		metodoPagoPanel.setLayout(new java.awt.CardLayout(0, 0));
		ingresoDatosCrearPanel.add(metodoPagoPanel,
		...
		efectivoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 2, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		metodoPagoPanel.add(efectivoPanel, "Card1");
		efectivoLabel = new JLabel();
		efectivoPanel.add(efectivoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
		...
		efectivoPanel.add(monto,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_NORTHWEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(160, -1), null, 0, false));
		debitoPanel = new JPanel();
		debitoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(3, 2, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		metodoPagoPanel.add(debitoPanel, "Card2");
		numeroTarjetaDebito = new JTextField();
		debitoPanel.add(numeroTarjetaDebito,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		debitoPanel.add(numeroDebitoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		debitoPanel.add(codSegDebitoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(2, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		debitoPanel.add(vencimientoDebitoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		vencimientoDebitoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		debitoPanel.add(vencimientoDebitoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		vencimientoDebitoPanel.add(mesDebitoBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		vencimientoDebitoPanel.add(anioDebitoBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		vencimientoDebitoPanel.add(spacer19, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		creditoPanel = new JPanel();
		creditoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(4, 2, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		metodoPagoPanel.add(creditoPanel, "Card3");
		numeroTarjetaCredito = new JTextField();
		creditoPanel.add(numeroTarjetaCredito,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		creditoPanel.add(codSegTarjetaCredito,
				new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		vencimientoCreditoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		creditoPanel.add(vencimientoCreditoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		vencimientoCreditoPanel.add(mesCreditoBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		vencimientoCreditoPanel.add(anioCreditoBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		vencimientoCreditoPanel.add(spacer20, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		numeroCreditoLabel = new JLabel();
		creditoPanel.add(numeroCreditoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		creditoPanel.add(vencimientoCreditoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		creditoPanel.add(codSegCreditoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(2, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		creditoPanel.add(cuotasBox,
				new com.intellij.uiDesigner.core.GridConstraints(3, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(20, -1), null, 0, false));
		cuotasCreditoLabel = new JLabel();
		creditoPanel.add(cuotasCreditoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(3, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		ingresoDatosCrearPanel.add(toolBar$Separator1,
				new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		ingresoDatosCrearPanel.add(toolBar$Separator2,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		turnosReservMedicxPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(2, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		ViewPanel.add(turnosReservMedicxPanel, "Card5");
		scrollPanel = new JScrollPane();
		turnosReservMedicxPanel.add(scrollPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel7.add(turnosMedicoTextPane,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		panel8.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		turnosReservMedicxPanel.add(panel8,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel8.add(cerrarSesionButton,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						...
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
								| com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null,
						new java.awt.Dimension(150, 30), null, 1, false));
		final com.intellij.uiDesigner.core.Spacer spacer21 = new com.intellij.uiDesigner.core.Spacer();
		panel8.add(spacer21, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer22 = new com.intellij.uiDesigner.core.Spacer();
		panel8.add(spacer22, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		mostrarTurnoConsultadoPanel = new JPanel();
		mostrarTurnoConsultadoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(2, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		ViewPanel.add(mostrarTurnoConsultadoPanel, "Card6");
		infoTurnoConsultadoPanel = new JPanel();
		infoTurnoConsultadoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(3, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		mostrarTurnoConsultadoPanel.add(infoTurnoConsultadoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		infoTurnoConsultadoPanel.add(tituloMostrarTurnoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		infoTurnoConsultadoPanel.add(spacer23, new com.intellij.uiDesigner.core.GridConstraints(2, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer24 = new com.intellij.uiDesigner.core.Spacer();
		infoTurnoConsultadoPanel.add(spacer24, new com.intellij.uiDesigner.core.GridConstraints(2, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer25 = new com.intellij.uiDesigner.core.Spacer();
		infoTurnoConsultadoPanel.add(spacer25,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
		...
		buttosMostrarTurnoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 5, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		mostrarTurnoConsultadoPanel.add(buttosMostrarTurnoPanel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel9.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		buttosMostrarTurnoPanel.add(panel9,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel10.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		buttosMostrarTurnoPanel.add(panel10,
				new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		buttosMostrarTurnoPanel.add(spacer26, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer27 = new com.intellij.uiDesigner.core.Spacer();
		buttosMostrarTurnoPanel.add(spacer27, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer28 = new com.intellij.uiDesigner.core.Spacer();
		buttosMostrarTurnoPanel.add(spacer28, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		cambiarMetodoPagoPanel = new JPanel();
		cambiarMetodoPagoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(3, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		...
		cambiarEfectivoPanel.add(cambiarEfectivoMontoLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_NORTHWEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		cambiarDebitoPanel.add(codSegTarjetaDebitoCambiar,
				new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		cambiarDebitoPanel.add(numeroTarjetaDebitoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		cambiarDebitoPanel.add(codSegDebitoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(2, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		cambiarDebitoPanel.add(vencimientoDebitoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		panel11.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		cambiarDebitoPanel.add(panel11,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel11.add(mesDebitoCambiarBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		panel11.add(spacer29, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		cambiarCreditoPanel = new JPanel();
		cambiarCreditoPanel.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(4, 2, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		nuevoMetodoPagoPanel.add(cambiarCreditoPanel, "Card3");
		numeroTarjetaCreditoCambiar = new JTextField();
		cambiarCreditoPanel.add(numeroTarjetaCreditoCambiar,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		cambiarCreditoPanel.add(codSegTarjetaCreditoCambiar,
				new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW,
		...
		panel12.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		cambiarCreditoPanel.add(panel12,
				new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel12.add(mesCreditoCambiarBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		panel12.add(anioCreditoCambiarBox,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW,
		...
		panel12.add(spacer30, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		numeroTarjetaCreditoCambiarLabel = new JLabel();
		cambiarCreditoPanel.add(numeroTarjetaCreditoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		cambiarCreditoPanel.add(vencimientoCreditoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		cambiarCreditoPanel.add(cuotasCreditoCambiarLabel,
				new com.intellij.uiDesigner.core.GridConstraints(3, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
		...
		panel13.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		cambiarButtonsPanel.add(panel13,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		cambiarButtonsPanel.add(spacer31, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		...
		panel14.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		cambiarButtonsPanel.add(panel14,
				new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel14.add(realizarCambioButton,
				new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		cambiarButtonsPanel.add(spacer32, new com.intellij.uiDesigner.core.GridConstraints(0, 4, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer33 = new com.intellij.uiDesigner.core.Spacer();
		cambiarButtonsPanel.add(spacer33, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer34 = new com.intellij.uiDesigner.core.Spacer();
		cambiarMetodoPagoPanel.add(spacer34, new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		final com.intellij.uiDesigner.core.Spacer spacer35 = new com.intellij.uiDesigner.core.Spacer();
		cambiarMetodoPagoPanel.add(spacer35, new com.intellij.uiDesigner.core.GridConstraints(1, 2, 1, 1,
				com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
				com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL,
				com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
		...
		panel15.setLayout(
				new com.intellij.uiDesigner.core.GridLayoutManager(1, 3, new java.awt.Insets(0, 0, 0, 0), -1, -1));
		cambiarMetodoPagoPanel.add(panel15,
				new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER,
						com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK
		...
		panel15.add(costoConsultaLabel2,
				new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1,
						com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST,
						com.intellij.uiDesigner.core.GridConstraints.FILL_NONE,
						com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED,
